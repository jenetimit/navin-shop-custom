      ...
      >
        <div className="flex items-center">
          ...
          <div className="px-8 flex flex-col justify-center me-auto overflow-hidden">
            <h3
              className="font-semibold text-lg lg:text-xl tracking-tight text-accent truncate cursor-pointer transition-colors hover:text-accent"
        ...
        <div className="flex justify-start md:w-1/2 p-5 md:pt-10 lg:p-14 xl:p-16">
          ...
          >
            <div className="flex flex-col items-start overflow-hidden">
              <div className="w-full">
                <h1
                  className="font-semibold text-lg md:text-xl xl:text-2xl tracking-tight text-accent cursor-pointer transition-colors hover:text-accent"
                  onClick={() => handleTitleClick(`/products/${slug}`)}
                  title={name}
                >
                  {name}
                ...
                <div className="mb-5 md:mb-10 flex items-center">
                  {!isEmpty(variations) ? (
                    ...
                    <span className="flex items-center">
                      <ins className="text-2xl md:text-3xl font-semibold text-active no-underline">
                        {/* {basePrice ? basePrice : price} */}
                        ₹{data?.sale_price}
                      </ins>
                ...
                <div className="mt-4 md:mt-6 flex flex-col lg:flex-row items-center">
                  <div className="mb-3 lg:mb-0 w-full lg:max-w-[400px]">
                    <AddToCart
                      data={data}
                      variant={(productSection?.length! > 0)?'dod':'big'}
                      section={(productSection?.length! > 0)?productSection:''}
              ...
              {shop?.name && (
                <div className="flex items-center mt-2">
                  <span className="text-sm font-semibold text-accent capitalize me-6 py-1">
