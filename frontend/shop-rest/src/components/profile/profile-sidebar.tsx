        ...
        {siteSettings.dashboardSidebarMenu
          ...
          .map((item: any, idx) => (
            <li className="py-2" key={idx}>
              ...
              >
                <a className="block py-2 px-10 font-semibold text-accent transition-colors border-l-4 border-transparent hover:text-accent focus:text-accent">
                  {t(item.menulabel)}
                </a>
              </NavLink>
            </li>
      ...
      <ul className="bg-light border-t border-border-200 py-4">
        {siteSettings.dashboardSidebarMenu?.slice(-1).map((item: any, idx) => (
          <li className="py-2" key={idx}>
            ...
            >
              <a className="block py-2 px-10 font-semibold text-accent transition-colors hover:text-accent focus:text-accent">
                {t(item.menulabel)}
              </a>
            </NavLink>
          </li>
