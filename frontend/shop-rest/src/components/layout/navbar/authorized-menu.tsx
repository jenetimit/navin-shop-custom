              ...
              {siteSettings.authorizedLinks.map(({ href, label }) => (
                <li key={`${href}${label}`}>
                  <button
                    ...
                    className="block w-full py-2.5 px-6 text-sm text-start font-semibold capitalize text-accent transition duration-200 hover:text-accent focus:outline-none"
                  >
                    {t(label)}
                  </button>
                </li>
