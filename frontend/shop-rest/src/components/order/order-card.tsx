  ...
  return (
    ...
    >
      <div className="flex justify-between items-center border-b border-border-200 py-3 px-5 md:px-3 lg:px-4">
        <span className="flex font-bold text-sm lg:text-base text-accent me-4 flex-shrink-0">
          {t("text-order")}
      ...
      <div className="flex flex-col p-5 md:p-3 lg:px-4 lg:py-5">
        <p className="text-sm text-accent w-full flex justify-between items-center mb-4 last:mb-0">
        ...
        <p className="text-sm font-bold text-accent w-full flex justify-between items-center mb-4 last:mb-0">
          <span className="w-24 overflow-hidden flex-shrink-0">
            {t("text-amount")}
          </span>
          <span className="me-auto">:</span>
