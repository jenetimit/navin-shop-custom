...
const LoginForm = () => {
  ...
  return (
    <div className="py-6 px-5 sm:p-8 bg-light w-screen md:max-w-md h-screen md:h-auto flex flex-col justify-center">
      ...
      <div className="flex flex-col items-center justify-center relative text-sm mt-8 sm:mt-11 mb-6 sm:mb-8">
        <hr className="w-full" />
      ...
      <div className="flex flex-col items-center justify-center relative text-sm text-accent mt-8 sm:mt-11 mb-6 sm:mb-8">
        <hr className="w-full" />
      </div>
