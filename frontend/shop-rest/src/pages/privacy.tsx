  ...
  return (
    <section className="max-w-1920 w-full mx-auto py-8 px-4 lg:py-10 lg:px-8 xl:py-14 xl:px-16 2xl:px-20">
      <header className="sm:mt-2 xl:mt-4 mb-10 lg:mb-14">
        <h1 className="text-xl md:text-2xl sm:text-3xl 2xl:text-4xl text-accent font-bold mb-4 sm:mb-5 2xl:mb-7">
          {t(title)}
        </h1>
            ...
            {content?.map((item) => (
              <li key={item.title}>
                <Link
                  ...
                  activeClass="text-sm lg:text-base text-accent font-semibold"
        ...
        <div className="md:w-9/12 md:ps-8 md:pb-96">
          {content?.map((item) => (
            <Element
              ...
              className="mb-10"
            >
              <h2 className="text-lg md:text-xl lg:text-2xl text-accent font-bold mb-4">
                {t(item.title)}
              </h2>
              <div
