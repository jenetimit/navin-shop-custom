  ...
  return (
    <div className="p-4 sm:p-8">
      <div className="p-6 sm:p-8 lg:p-12 max-w-screen-lg w-full mx-auto bg-light rounded border shadow-sm">
        <h2 className="flex flex-col sm:flex-row items-center justify-between text-base font-bold text-accent mb-9 sm:mb-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-12">
          <div className="py-4 px-5 border border-border-200 rounded shadow-sm">
            <h3 className="mb-2 text-sm text-accent font-semibold">
              {t("text-order-number")}
            </h3>
          ...
          <div className="w-full lg:w-1/2 lg:pe-3 mb-12 lg:mb-0">
            ...
            <div>
              <p className="flex text-body-dark mt-5">
                <strong className="w-5/12 sm:w-4/12 text-sm  text-accent font-semibold">
                  {t("text-sub-total")}
                </strong>
                :
